...
register(
        id='TiagoMaze-v0',
        entry_point='openai_ros.task_envs.tiago.tiago_maze:TiagoMazeEnv',
        max_episode_steps=max_episode_steps_per_episode,
    )

class TiagoMazeEnv(tiago_env.TiagoEnv):
    def __init__(self):
        """
        ...
        self.dec_obs = rospy.get_param("/tiago/number_decimals_precision_obs", 1)
        ...
        self.n_observations = rospy.get_param('/tiago/n_observations')
        ...
        super(TiagoMazeEnv, self).__init__()
